...
#   Unknown type 'mpaa_rating' for column 'rating'
  ...
  create_table "payment_p2017_01", id: false, force: :cascade do |t|
    ...
    t.decimal "amount", precision: 5, scale: 2, null: false
    t.datetime "payment_date", null: false
    t.index ["customer_id"], name: "idx_fk_payment_p2017_01_customer_id"
    t.index ["staff_id"], name: "idx_fk_payment_p2017_01_staff_id"
  end

  create_table "payment_p2017_02", id: false, force: :cascade do |t|
    t.integer "payment_id", default: -> { "nextval('payment_payment_id_seq'::regclass)" }, null: false
    t.integer "customer_id", limit: 2, null: false
    t.integer "staff_id", limit: 2, null: false
    t.integer "rental_id", null: false
    t.decimal "amount", precision: 5, scale: 2, null: false
    t.datetime "payment_date", null: false
    t.index ["customer_id"], name: "idx_fk_payment_p2017_02_customer_id"
    t.index ["staff_id"], name: "idx_fk_payment_p2017_02_staff_id"
  end

  create_table "payment_p2017_03", id: false, force: :cascade do |t|
    t.integer "payment_id", default: -> { "nextval('payment_payment_id_seq'::regclass)" }, null: false
    t.integer "customer_id", limit: 2, null: false
    t.integer "staff_id", limit: 2, null: false
    t.integer "rental_id", null: false
    t.decimal "amount", precision: 5, scale: 2, null: false
    t.datetime "payment_date", null: false
    t.index ["customer_id"], name: "idx_fk_payment_p2017_03_customer_id"
    t.index ["staff_id"], name: "idx_fk_payment_p2017_03_staff_id"
  end

  create_table "payment_p2017_04", id: false, force: :cascade do |t|
    t.integer "payment_id", default: -> { "nextval('payment_payment_id_seq'::regclass)" }, null: false
    t.integer "customer_id", limit: 2, null: false
    t.integer "staff_id", limit: 2, null: false
    t.integer "rental_id", null: false
    t.decimal "amount", precision: 5, scale: 2, null: false
    t.datetime "payment_date", null: false
    t.index ["customer_id"], name: "idx_fk_payment_p2017_04_customer_id"
    t.index ["staff_id"], name: "idx_fk_payment_p2017_04_staff_id"
  end

  create_table "payment_p2017_05", id: false, force: :cascade do |t|
    t.integer "payment_id", default: -> { "nextval('payment_payment_id_seq'::regclass)" }, null: false
    t.integer "customer_id", limit: 2, null: false
    t.integer "staff_id", limit: 2, null: false
    t.integer "rental_id", null: false
    t.decimal "amount", precision: 5, scale: 2, null: false
    t.datetime "payment_date", null: false
    t.index ["customer_id"], name: "idx_fk_payment_p2017_05_customer_id"
    t.index ["staff_id"], name: "idx_fk_payment_p2017_05_staff_id"
  end

  create_table "payment_p2017_06", id: false, force: :cascade do |t|
    t.integer "payment_id", default: -> { "nextval('payment_payment_id_seq'::regclass)" }, null: false
    t.integer "customer_id", limit: 2, null: false
    t.integer "staff_id", limit: 2, null: false
    t.integer "rental_id", null: false
    t.decimal "amount", precision: 5, scale: 2, null: false
    t.datetime "payment_date", null: false
    t.index ["customer_id"], name: "idx_fk_payment_p2017_06_customer_id"
    t.index ["staff_id"], name: "idx_fk_payment_p2017_06_staff_id"
  end
